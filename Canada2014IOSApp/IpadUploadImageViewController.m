//
//  IpadUploadImageViewController.m
//  Winter2014IOSApp
//
...
-(IBAction)selectPicturePressed:(id)sender
{
    ...
    CGRect popoverRect = [self.view convertRect:[selectPhotoBtn frame]
                                       fromView:[selectPhotoBtn superview]];
